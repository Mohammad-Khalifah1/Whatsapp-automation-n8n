  ...
  nodes.push(
    codeNode(
      ...
      [
        ...
        '// Signature checking is REQUIRED whenever an app secret is configured.',
        '// Leaving META_APP_SECRET empty is only acceptable for local fixture',
        '// testing and is loudly recorded in the audit event below.',
        "const required = !!(appSecret && String(appSecret).trim() !== '');",
        '',
